...
int main(void)
{
	...
	const char** ppGlfwExtensionNames = glfwGetRequiredInstanceExtensions(&glfwExtensionCount);
	...
	//Create instance
	VkInstance instance = createInstance(extensionCount, ppExtensionNames, layerCount, ppLayerNames);
	...
	VkDevice device = createLogicalDevice(physicalDevice,(uint32_t)graphicsQueueIndex, deviceExtensionCount , ppDeviceExtensionNames, layerCount, ppLayerNames);
